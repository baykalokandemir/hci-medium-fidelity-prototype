                    ...
                    <div class="p-8 w-full text-white">
                        <div class="flex justify-between items-end flex-wrap gap-4">
                            ...
                            <div class="flex gap-3 mt-4 sm:mt-0">
                                ...
                                <button @click.stop="toggleSave" class="p-3.5 bg-white/20 hover:bg-white/30 backdrop-blur rounded-xl transition-all hover:scale-105 text-white shadow-lg">
                                    <Bookmark class="w-5 h-5" :class="{ 'fill-yellow-400 text-yellow-400': isSaved }" />
                                </button>
                            </div>
                        </div>
                    </div>
